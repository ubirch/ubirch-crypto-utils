...
public final class KeyPairGenerator extends KeyPairGeneratorSpi {
    ...
    static {
        ...
        edParameters.put(DEFAULT_STRENGTH, new EdDSAGenParameterSpec(EdDSANamedCurveTable.CURVE_ED25519_SHA512));
    }

    public void initialize(int strength, SecureRandom random) {
        AlgorithmParameterSpec edParams = edParameters.get(strength);
        if (edParams == null)
